...
public class FrequenciaListView extends LinearLayout {
    ...
    private MyJSONObject frequencia;
    private View view;

    private TextView membro_;
    private CheckBox cb;

    public FrequenciaListView(Context context, AttributeSet attrs, MyJSONObject frequencia, MyJSONObject membro) {
        super(context, attrs);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        membro_.setText(membro.getString("nome"));

        cb = view.findViewById(R.id.frequencia_cb);
        cb.setChecked(frequencia.getInt("ausente") == 1);
